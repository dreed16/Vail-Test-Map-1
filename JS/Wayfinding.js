...
let pendingNavigationPoints = [];

// Function to initialize navigation when map is ready
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Check if map exists every 100ms
    const checkMap = setInterval(function() {
        if (typeof map !== 'undefined' && map) {
            console.log('Map found, initializing navigation...');
            mapInitialized = true;
